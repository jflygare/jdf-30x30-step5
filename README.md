...
function ng_setup() {
  ...
  # Generate main navigation component
  # https://material.angular.io/guide/schematics#navigation-schematic
  npx ng generate @angular/material:navigation main \
    --defaults \
    --skip-tests \
    --style=css

  # Generate login component using address form schematic as a starter
  # https://material.angular.io/guide/schematics#address-form-schematic
  npx ng generate @angular/material:address-form login \
    --defaults \
    --skip-tests \
    --style=css
}
